...
#' @param method Character. Should be either \code{"SCVI"} or \code{"SVI"} if the algorithm
...
#' @param V.init List of numeric vectors. Initial values for \eqn{V}. By default \eqn{V=h}.
...
#' @return An S4 object containing the outputs. Elements are accessed with @@. The slots are:
#' \itemize{
